export const renderNonCheckedMember = (user: any) => {
  return `
    ...
    <input class="details__member-cost form-control form-control-sm non-fixed" type="text" value="" disabled>
    <textarea class="details__member-comment form-control" disabled></textarea>
